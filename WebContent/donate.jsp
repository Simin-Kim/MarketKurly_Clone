...
<body>
    <div id="wrap">
        ...
        <div class="mainWrap">
            <div class="main">
                <h1 class="title">기부상품</h1>
                <ul class="product">
                    <li>
                        <img class="productImg" src="./assets/img/coffee.jfif">
                        <div class="productText" href="">
                            <span class="productTitle">종이필터없이 커피 만들기, 스테인레스 커피필터</span>
                            <span class="progPer">100%</span></a>
                        </div>
                        <div class="progress"><progress value="100" max=100></progress></div>
                        <div class="btn">
                            <button class="doBtn">기부하기</button>
