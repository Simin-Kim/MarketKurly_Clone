...
<body>
    <div id="wrap">
        ...
        <div class="mainWrap">
            <div class="main">
            	<form action="./idFindAction.jsp" method="POST">
                    <h3 class="loginTitle">아이디 찾기</h3>
                    <div class="loginBox">
                        <span class="label">이름</span>
                        <input class="name" type="text" name="name" value maxlength="16" required=""
                            placeholder="이름을 입력해주세요" label="이름">
                        <span class="label">이메일</span>
                        <input class="email" type="email" name="email" value="" required="" fld_esssential=""
